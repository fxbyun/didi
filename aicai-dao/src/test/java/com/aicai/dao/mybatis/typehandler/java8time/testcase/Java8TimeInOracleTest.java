...
@ContextConfiguration(locations = { "classpath:typehandler/java8time/oracle/spring-context.xml" })
public class Java8TimeInOracleTest extends AbstractJUnit4SpringContextTests{
	...
	public void query() {
		...
		Java8Time java8Time = genericDao.queryUnique("Java8TimeDao.selectByPrimaryKey", 2);
